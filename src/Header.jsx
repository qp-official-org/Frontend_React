...
function Header() {
  ...
  const handleLogin = () => {
    setIsLogined(true);
    setAccessToken(
      'eyJhbGciOiJIUzUxMiJ9.eyJ1c2VySWQiOjUyMCwiaWF0IjoxNzA4MjcyNTk0LCJleHAiOjE3MDgyNzk3OTR9.yG2OLHihbjmSW8J1ZTe4OnsCW9RyjlFk7NjHARfIH4kh0OVj3kDvJWDoi3UpEGGB6Vpmk_1ppLF-OU6EgGbepA'
    );
    ...
    localStorage.setItem(
      'accesstoken',
      'eyJhbGciOiJIUzUxMiJ9.eyJ1c2VySWQiOjYsImlhdCI6MTcwODIzNzM5NCwiZXhwIjoxNzA4MjQ0NTk0fQ.Hf2qB8IOnorpm3zYg0i2zUY8rFqwHF_tbB0t0s6Wi3dHlTTwx3DfbDj9VruWdVY10fFKX7EUdDYw4bYqp495mA'
    );
